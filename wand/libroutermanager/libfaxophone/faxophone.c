...
static int capi_init(int controller)
{
  printf("Beginn capi_init, controller: %d\n",controller);
...
{
  printf("Beginn faxophone_init, controller: %d\n",controller);
	int appl_id = -1;
