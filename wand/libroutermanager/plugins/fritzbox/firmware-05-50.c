...
{
  printf("Beginn fritzbox_login_05_50\n");
	SoupMessage *msg;
	gchar *response = NULL;
	gsize read;
  ...
  printf("Beginn fritzbox_login_05_50\n");
	...
	if (!strcmp(profile->router_info->session_id, "0000000000000000")) {
		const gchar *user = g_strdup("libelle17"); // router_get_login_user(profile);
		const gchar *password = g_strdup("bach17raga"); // router_get_login_password(profile);
...
gboolean fritzbox_get_fax_information_05_50(struct profile *profile)
{
  ...
  printf("Beginn fritzbox_get_fax_information_05_50\n");
...
gboolean fritzbox_get_fax_information_06_00(struct profile *profile)
{
  ...
  printf("Beginn fritzbox_get_fax_information_06_00\n");
...
gboolean fritzbox_get_settings_05_50(struct profile *profile)
{
  ...
  printf("Beginn fritzbox_get_settings_05_50\n");
...
gboolean fritzbox_load_journal_05_50(struct profile *profile, gchar **data_ptr)
{
	...
	/* Create GET request */
  printf("Beginn fritzbox_load_journal_05_50\n");
...
gboolean fritzbox_clear_journal_05_50(struct profile *profile)
{
  ...
  printf("Beginn fritzbox_clear_journal_05_50\n");
