...
<h1 align="center">ROGERJ (Version 0.10124) - english<a name="english_D"></a></h1>
...
<p style="margin-left:11%; margin-top: 1em"><b>rogerj
...
rogerj&rsquo; oder &rsquo;man -Lde rogerj&rsquo;)</p>
...
Furthermore, rogerj holds the posted faxes in a mariadb
database. <br>
...
<b><br>
rogerj -again</b> for each of then. Hereby the necessary
...
When <b>rogerj</b> is called for the next time (per default
...
at 10 p.m., if rogerj is running. <br>
...
At each call, rogerj checks the status of <b>hylafax</b>
and/or <b>Capisuite</b>. The Finishing of a fax process
there causes rogerj to move the source files (here the above
mentioned .doc- and .pdf-files) from the waiting directory
to one or several archive directories or a directory for
failed faxes and to move their database record from
&rsquo;<b>spooltab</b>&rsquo; to the archive table
...
by calling &rsquo;<b>rogerj&rsquo;, &rsquo;rogerj
-lista</b>&rsquo;, &rsquo;<b>rogerj -listf</b>&rsquo; or
&rsquo;<b>rogerj -listi</b>&rsquo;.</p>
...
<p style="margin-left:11%; margin-top: 1em">&rsquo;<b>rogerj
-?</b>&rsquo; or &rsquo;<b>rogerj -h</b>&rsquo; shows the
important command line options and &rsquo;<b>rogerj
...
&rsquo;<b>rogerj -vi</b>&rsquo; or interactively by
&rsquo;<b>rogerj -rf</b>&rsquo;. <b><br>
...
be used instead of &rsquo;<b>rogerj.log</b>&rsquo; <b><br>
-l, --log</b>: put detailed logs in file
&rsquo;<b>/var/log/rogerj.log</b>&rsquo; (otherwise shorter)
<b><br>
...
&lt;string&gt; instead of &rsquo;<b>rogerj</b>&rsquo;
-1lg.SH FUNCTIONALITY</p>

<p style="margin-left:11%; margin-top: 1em">When called,
&rsquo;<b>rogerj</b>&rsquo; accomplishes the following:</p>
...
can be overloaded by the rogerj configuration file (see 4),
...
exists (per default <b>rogerj.conf</b> in the same directory
as <b>rogerj</b>, per default
<b>/usr/local/sbin/rogerj</b>))</p>
...
the already generated rogerj entries can be commented out
...
detected which are not created via rogerj, they are
displayed. In intervals they will be integrated into the
rogerj database (without the not available information on
...
will be used by rogerj to name the received faxes. Before
...
number of <b>rogerj</b> will be compared with that of the
...
Uninstalling of the programs added by rogerj by <b>make
...
keep an older version of one, You may not install rogerj or
...
configuration file <b>rogerj.conf</b> in the same directory
...
After calling rogerj, the directories mentioned in 8) should
be readable via samba within a local network and the
...
specific command line options for rogerj, faxes can be
...
a specific command line option for rogerj, an old received
...
installed user, it&rsquo;s <b>cd ~/rogerj</b>, otherwise it
will be displayed by <b>rogerj -info</b>). <br>
Call <b>make uninstall</b>. <br>
Then the installed <b>rogerj</b> will be deleted and the
script <b>uninstallinv</b> will be executed in reverse order
which has been generated during the installation and
execution of rogerj. <br>
...
7</b>: The info screen (<b>rogerj -info</b>) has been
displayed <b><br>
...
After calling <b>rogerj -vi</b> or <b>rogerj -vs</b> the
...
any errors with the word &rsquo;rogerj&rsquo; included in
...
(&rsquo;<b>~/rogerj</b>), You may alter the program.</p>
...
<h1 align="center">ROGERJ (Version 0.10124) - deutsch<a name="deutsch_D"></a></h1>
...
(manpage available in english: &rsquo;man rogerj&rsquo; or
&rsquo;man -Len rogerj&rsquo;)</p>
...
rogerj</b> ist ein Befehlszeilenprogramm, mit dem Dateien in
...
im Dateinamen wie vorgesehen eingetragen ist, und das
weiterhin die versandten Faxe in einer MariaDB-Datenbank
abspeichert. <br>
...
Eintrag der f&uuml;r rogerj relevanten Verzeichnisse in
...
rogerj -erneut f&uuml;r jedes von Ihnen. Hierdurch wird
...
Wenn <b>rogerj</b> beim n&auml;chsten Mal automatisch
...
Bei jedem Aufruf &uuml;berpr&uuml;ft rogerj den
Status von <b>hylafax</b> und/oder <b>Capisuite</b>. Der
Abschluss eines Faxvorgangs dort hat zur Folge, dass rogerj
...
durch Aufruf von z.B. &rsquo;<b>rogerj&rsquo;, &rsquo;rogerj
-lista</b>&rsquo;, &rsquo;<b>rogerj -listf</b>&rsquo; oder
&rsquo;<b>rogerj -listi</b>&rsquo; den Stand des Faxens
...
<p style="margin-left:11%; margin-top: 1em">&rsquo;<b>rogerj
-?</b>&rsquo; oder &rsquo;<b>rogerj -h</b>&rsquo; zeigt die
wichtigen Befehlszeilenoptionen und &rsquo;<b>rogerj
...
werden, die wiederum &uuml;ber &rsquo;<b>rogerj
-vi</b>&rsquo; direkt editiert oder auch &uuml;ber
&rsquo;<b>rogerj -rf</b>&rsquo; interaktiv gepflegt werden
kann. <b><br>
...
anstatt &rsquo;<b>rogerj.log</b>&rsquo; <b><br>
-l, --log</b>: protokolliert ausfuehrlich in Datei
&rsquo;<b>/var/log/rogerj.log</b>&rsquo; (sonst knapper)
<b><br>
...
&lt;string&gt; anstatt &rsquo;<b>rogerj</b>&rsquo; -1lg.SH
FUNKTIONSWEISE</p>

<p style="margin-left:11%; margin-top: 1em">Beim Aufruf von
&rsquo;<b>rogerj</b>&rsquo; geschieht folgendes:</p>
...
durch die rogerj-Konfigurationsdatei (siehe 4),
...
<b>rogerj.conf</b> im selben Verzeichnis wie <b>rogerj</b>,
...
rogerj-Eintr&auml;ge mit <b>crontab -e</b> mit einem
...
befindliche, nicht &uuml;ber rogerj erstellte Faxe
werden ggf. angezeigt. In Intervallen werden sie in die
rogerj-Datenbank integriert (ohne die fehlende Information
...
dann, durch ein Komma getrennt, von rogerj zur Benennung
...
Konfigurationsdatei <b>rogerj.conf</b> wird ggf.
geschrieben.</p>
...
Versionsummer von <b>rogerj</b> mit der der
...
vorausgesetzt. Die Deinstallation der durch rogerj
...
aktualisieren wollen, dann d&uuml;rfen Sie rogerj oder
...
rogerj.conf in dem Verzeichnis, in dem auch es selbst steht
(Vorgabe: /usr/local/sbin/rogerj).</p>
...
<p style="margin-left:11%; margin-top: 1em"><b>13)</b>
durch entsprechende Befehlszeilenoptionen von rogerj
...
eingeloggten Benutzer: <b>cd ~/rogerj</b>, ansonsten wird es
&uuml;ber <b>rogerj -info</b> angezeigt). <br>
Rufen Sie dort <b>make uninstall</b> auf. <br>
Dadurch wird das installierte <b>rogerj</b>
gel&ouml;scht und das Script <b>uninstallinv</b> in
umgekehrter Reihenfolge abgearbeitet, das bei der
Installation und beim Aufruf von rogerj erstellt wurde. <br>
Dadurch werden zus&auml;tzlich installierte
Programmpakete, zus&auml;tzlich erteilte Berechtigungen,
f&uuml;r rogerj eingerichtete Sambafreigaben und
...
7</b>: Der Infobildschirm (<b>rogerj -info</b>) wurde
angezeigt <b><br>
...
l&auml;uft <b><br>
99</b>: Suchbefehl mit <b>rogerj -fd 2</b> bei Dateilink
misslungen <b><br>
...
Festplatte <br>
Nach Aufruf von <b>rogerj -vi</b> oder <b>rogerj -vs</b>
...
mit u.a. dem Wort &rsquo;rogerj&rsquo; in der
...
(&rsquo;<b>~/rogerj</b>) aus k&ouml;nnen Sie das
